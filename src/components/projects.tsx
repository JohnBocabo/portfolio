    ...
    <div id='projects' className="flex gap-9 flex-col w-full  min-h-[500px] mt-4">
        ...
        <div className="w-full border-2 p-6 rounded-md hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="mb-4">
                ...
                <ul className="text-xs md:text-base font-light list-disc list-inside space-y-1 ml-4">
                    <li>Member registration and management system</li>
                    <li>QR code generation for event attendance tracking</li>
                    <li>Event management and monitoring</li>
                    <li>AI-powered chatbot for user assistance</li>
                    <li>Sanity Headless CMS for blogs</li>
            ...
            <div>
                ...
                <div className="flex flex-wrap gap-3 items-center">
                    <div className="flex items-center gap-2 bg-gray-800 px-2 py-1 md:px-3 md:py-2 rounded-md">
                    ...
                    <div className="flex items-center gap-2 bg-gray-800 px-2 py-1 md:px-3 md:py-2 rounded-md">
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/postgresql/postgresql-original.svg" alt="PostgreSQL" className="size-4 md:size-6" />
                    ...
                    <div className="flex items-center gap-2 bg-gray-800 px-2 py-1 md:px-3 md:py-2 rounded-md">
                        <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/sanity/sanity-original.svg" alt="Sanity" className="size-4 md:size-6" />
